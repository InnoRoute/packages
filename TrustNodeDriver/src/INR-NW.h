...
**/
#define INR_NWDEV_features NETIF_F_SG | NETIF_F_IP_CSUM | NETIF_F_FRAGLIST	//|  NETIF_F_HW_VLAN_TX
/**
...
#define INR_NW_devcount 16	/* count of NW-devices */
#define INR_NW_repeatonbusy 0	/* repeat sending packetes to hardware if device is busy */
//prototypes
...
//  .ndo_do_ioctl = INR_NW_ioctl,/* define ioctl callback*/
