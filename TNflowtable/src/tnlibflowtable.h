...
//hashtable with hardcoded filds
...
//ruletable with hardcoded filds
...
//collision table with hardcoded filds
...
struct INR_FC_EMH_RULE_TYPE1
{
  ...
  uint8_t filling[16];		//dont care bits...
...
struct INR_FC_EMH_RULE_TYPE2
{
  ...
  uint8_t filling[19];		//dont care bits...
  uint8_t unused;		//dont care bits...
} __attribute__ ((__packed__));
