...
get_HASH (struct arguments *arguments)
{
	...
	arguments->HASH.EMA.MAC_SRC =	(0xff & (arguments->MAC_SRC >> 0)) ^
	                              ...
	                              (0xff & (arguments->MAC_SRC >> 24)) ^
	                              (0xff & (arguments->MAC_SRC >> 32)) ^
	                              (0xff & (arguments->MAC_SRC >> 40));

	arguments->HASH.EMA.MAC_DST = (0xff & (arguments->MAC_DST >> 0)) ^
	                              (0xff & (arguments->MAC_DST >> 8)) ^
	                              (0xff & (arguments->MAC_DST >> 16)) ^
	                              (0xff & (arguments->MAC_DST >> 24)) ^
	                              (0xff & (arguments->MAC_DST >> 32)) ^
	                              (0xff & (arguments->MAC_DST >> 40));

	arguments->HASH.EMA.ETHERTYPE = (0xf & (arguments->ETHERTYPE >> 0)) ^
	                                (0xf & (arguments->ETHERTYPE >> 4)) ^
	                                (0xf & (arguments->ETHERTYPE >> 8)) ^
	                                (0xf & (arguments->ETHERTYPE >> 12));

	arguments->HASH.EMA.VLAN_ID = (0xf & (arguments->VLAN_ID << 0)) ^
	                              (0xf & (arguments->VLAN_ID << 4)) ^
	                              (0xf & (arguments->VLAN_ID << 8));

	arguments->HASH.EMA.VLAN_PRIO = 0x7 & (arguments->VLAN_PRIO);

	arguments->HASH.EMA.IPv4_SRC = (0xff & (arguments->IPv4_SRC >> 0)) ^
	                               (0xff & (arguments->IPv4_SRC >> 8)) ^
	                               (0xff & (arguments->IPv4_SRC >> 16)) ^
	                               (0xff & (arguments->IPv4_SRC >> 24));

	arguments->HASH.EMA.IPv4_DST = (0xff & (arguments->IPv4_DST >> 0)) ^
	                               (0xff & (arguments->IPv4_DST >> 8)) ^
	                               (0xff & (arguments->IPv4_DST >> 16)) ^
	                               (0xff & (arguments->IPv4_DST >> 24));

	arguments->HASH.EMA.PROTOCOL = (0xf & (arguments->PROTOCOL >> 0)) ^
	                               (0xf & (arguments->PROTOCOL >> 4));

	arguments->HASH.EMA.TOS = (0x7 & (arguments->TOS >> 0)) ^
	                          (0x7 & (arguments->TOS >> 3));

	arguments->HASH.EMA.PORT_SRC = (0xf & (arguments->PORT_SRC >> 0)) ^
	                               (0xf & (arguments->PORT_SRC >> 4)) ^
	                               (0xf & (arguments->PORT_SRC >> 8)) ^
	                               (0xf & (arguments->PORT_SRC >> 12));

	arguments->HASH.EMA.PORT_DST = (0xf & (arguments->PORT_DST >> 0)) ^
	                               (0xf & (arguments->PORT_DST >> 4)) ^
	                               (0xf & (arguments->PORT_DST >> 8)) ^
	                               (0xf & (arguments->PORT_DST >> 12));
