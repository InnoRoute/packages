...
export C_MMI_ADDR_MAP_REVISION=4 # Address map version: to be checked against value read from C_BASE_ADDR_TN_COMMON_L -> C_SUB_ADDR_COMMON_ADDR_MAP_REV
...
##--------------------------------------------------------------------------
  ...
  export C_BASE_ADDR_MDIO=0x0004 #; -- mmi_mdio
  ...
  export C_BASE_ADDR_PERIPH=0x0005 #; -- mmi_peripherals
