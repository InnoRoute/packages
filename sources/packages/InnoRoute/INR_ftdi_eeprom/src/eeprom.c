...
unsigned char magic_dat[] = {
  0x01, 0x04, 0x03, 0x04, 0x10, 0x60, 0x00, 0x07, 0xc0, 0x2f, 0x08, 0x00, 0x00, 0x00, 0x9a, 0x12,
  0xac, 0x34, 0xe0, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x56, 0x00, 0x01, 0x00, 0xc7, 0x92, 0x6a, 0x35, 
  0x51, 0x01, 0x80, 0x30, 0x4a, 0x74, 0x61, 0x67, 0x53, 0x6d, 0x74, 0x31, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 'I', 'n', 'n', 'o', 'R', 'o', 'u', 't', 'e', ' ', ' ', 
  'G', 'm', 'b', 'H', ' ', ' ', 'T', 'r', 'u', 's', 't', 'N', 'o', 'd', 'e', 0x00,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x03, 'I', 0x00, 'n', 0x00,
  'n', 0x00, 'o', 0x00, 'R', 0x00, 'o', 0x00, 'u', 0x00, 't', 0x00, 'e', 0x03, ' ', 0x00,
  ' ', 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x9E, 0xFD
};
...
int main(int argc, char **argv)
{
    ...
    while ((i = getopt(argc, argv, "d::ev:p:l:P:S:w:M")) != -1)
    {
        switch (i)
        {
            case 'd':
 ...
 if (magic){
	printf("writing INR content to eeprom *g*\n");
	...
	ftdi_set_eeprom_buf(ftdi, magic_dat, 256);
	f = ftdi_write_eeprom(ftdi);
        {
            fprintf(stderr, "ftdi_eeprom_decode: %d (%s)\n",
                    f, ftdi_get_error_string(ftdi));
