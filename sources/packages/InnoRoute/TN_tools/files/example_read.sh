...
echo "C_SUB_ADDR_COMMON_FPGA_ALARM (RO,COR)"
tn_ll_mmi_read 0x000604
tn_ll_mmi_read 0x000604
echo "C_SUB_ADDR_COMMON_CONFIG_CHECK (RO,COR)"
tn_ll_mmi_read 0x000608
tn_ll_mmi_read 0x000608
echo "C_SUB_ADDR_COMMON_FIFO_OVERFLOW0 (RO,COR)"
tn_ll_mmi_read 0x000610
tn_ll_mmi_read 0x000610
echo "C_SUB_ADDR_COMMON_FIFO_OVERFLOW1 (RO,COR)"
tn_ll_mmi_read 0x000614
tn_ll_mmi_read 0x000614
echo "C_SUB_ADDR_COMMON_FIFO_OVERFLOW2 (RO,COR)"
tn_ll_mmi_read 0x000618
tn_ll_mmi_read 0x000618
echo "C_SUB_ADDR_COMMON_FIFO_OVERFLOW3 (RO,COR)"
tn_ll_mmi_read 0x00061C
tn_ll_mmi_read 0x00061C
echo "C_SUB_ADDR_COMMON_FIFO_UNDERRUN0 (RO,COR)"
tn_ll_mmi_read 0x000620
tn_ll_mmi_read 0x000620
echo "C_SUB_ADDR_COMMON_FIFO_UNDERRUN1 (RO,COR)"
tn_ll_mmi_read 0x000624
tn_ll_mmi_read 0x000624
echo "C_SUB_ADDR_COMMON_FIFO_UNDERRUN2 (RO,COR)"
tn_ll_mmi_read 0x000628
tn_ll_mmi_read 0x000628
echo "C_SUB_ADDR_COMMON_FIFO_UNDERRUN3 (RO,COR)"
tn_ll_mmi_read 0x00062C
tn_ll_mmi_read 0x00062C
echo "C_SUB_ADDR_COMMON_PCIE_ERROR0 (RO,COR)"
tn_ll_mmi_read 0x000630
tn_ll_mmi_read 0x000630
echo "C_SUB_ADDR_COMMON_PCIE_ERROR1 (RO,COR)"
...
echo "C_SUB_ADDR_COMMON_TXF_FULL (RO,COR)"
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port0"
tn_ll_mmi_read 0x80000C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port1"
tn_ll_mmi_read 0x80010C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port2"
tn_ll_mmi_read 0x80020C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port3"
tn_ll_mmi_read 0x80030C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port4"
tn_ll_mmi_read 0x80040C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port5"
tn_ll_mmi_read 0x80050C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port6"
tn_ll_mmi_read 0x80060C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port7"
tn_ll_mmi_read 0x80070C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port8"
tn_ll_mmi_read 0x80080C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port9"
tn_ll_mmi_read 0x80090C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port10"
tn_ll_mmi_read 0x800A0C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port11"
tn_ll_mmi_read 0x800B0C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port12"
tn_ll_mmi_read 0x800C0C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port13"
tn_ll_mmi_read 0x800D0C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port14"
tn_ll_mmi_read 0x800E0C
...
echo "C_SUB_ADDR_HC_DEFAULT_FLOWID Port15"
tn_ll_mmi_read 0x800F0C
...
echo "C_BASE_ADDR_PCIE_0 Word0"
tn_ll_mmi_read 0x808E00
echo "C_BASE_ADDR_PCIE_0 Word1"
tn_ll_mmi_read 0x808E04
echo "C_BASE_ADDR_PCIE_0 Word2"
tn_ll_mmi_read 0x808E08
echo "C_BASE_ADDR_PCIE_0 Word3"
tn_ll_mmi_read 0x808E0C
echo "C_BASE_ADDR_PCIE_1 Word0"
tn_ll_mmi_read 0x808F00
echo "C_BASE_ADDR_PCIE_1 Word1"
tn_ll_mmi_read 0x808F04
echo "C_BASE_ADDR_PCIE_1 Word2"
tn_ll_mmi_read 0x808F08
echo "C_BASE_ADDR_PCIE_1 Word3"
tn_ll_mmi_read 0x808F0C

echo "C_SUB_ADDR_ETH_SW_COMMON DP0"
tn_ll_mmi_read 0x810000
echo "C_SUB_ADDR_ETH_SW_AGEING DP0"
tn_ll_mmi_read 0x810004
...
echo "C_SUB_ADDR_ETH_SW_AGEING DP1"
tn_ll_mmi_read 0x820004
...
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP0 Word0"
tn_ll_mmi_read 0x830000
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP0 Word1"
tn_ll_mmi_read 0x830004
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP0 Word2"
tn_ll_mmi_read 0x830008
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP0 Word3"
tn_ll_mmi_read 0x83000C
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP1 Word0"
tn_ll_mmi_read 0x850000
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP1 Word1"
tn_ll_mmi_read 0x850004
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP1 Word2"
tn_ll_mmi_read 0x850008
echo "C_BASE_ADDR_STATISTICS_RX_BADRSN_LOWER DP1 Word3"
tn_ll_mmi_read 0x85000C

echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0x831000
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0x831004
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0x831008
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0x83100c
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0x851000
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0x851004
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0x851008
echo "C_BASE_ADDR_STATISTICS_RX_PKT_CNT_LOWER_1 DP1 Word 3"
tn_ll_mmi_read 0x85100c

echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0x832000
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0x832004
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0x832008
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0x83200c
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0x852000
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0x852004
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0x852008
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_FLOWID_LOWER_1 DP1 Word 3"
tn_ll_mmi_read 0x85200c

echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0x833000
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0x833004
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0x833008
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0x83300c
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0x853000
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0x853004
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0x853008
echo "C_BASE_ADDR_STATISTICS_RX_GOOD_PRT_LOWER_1 DP1 Word 3"
...
echo "C_BASE_ADDR_FLOW_CACHE_EMA_CAM_LOWER Word0"
tn_ll_mmi_read 0xC20000
echo "C_BASE_ADDR_FLOW_CACHE_EMA_CAM_LOWER Word1"
tn_ll_mmi_read 0xC20004
echo "C_BASE_ADDR_FLOW_CACHE_EMA_CAM_LOWER Word2"
tn_ll_mmi_read 0xC20008
echo "C_BASE_ADDR_FLOW_CACHE_EMA_CAM_LOWER Word3"
tn_ll_mmi_read 0xC2000C
echo "C_SUB_ADDR_FLOW_CACHE_ENABLE"
...
tn_ll_mmi_read 0xF30000
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP0 Word1"
tn_ll_mmi_read 0xF30004
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP0 Word2"
tn_ll_mmi_read 0xF30008
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP0 Word3"
tn_ll_mmi_read 0xF3000C
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP1 Word0"
tn_ll_mmi_read 0xF50000
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP1 Word1"
tn_ll_mmi_read 0xF50004
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP1 Word2"
tn_ll_mmi_read 0xF50008
echo "C_BASE_ADDR_STATISTICS_TX_BADRSN_LOWER DP1 Word3"
tn_ll_mmi_read 0xF5000C

echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0xF31000
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0xF31004
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0xF31008
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0xF3100c
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0xF51000
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0xF51004
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0xF51008
echo "C_BASE_ADDR_STATISTICS_TX_PKT_CNT_LOWER_1 DP1 Word 3"
tn_ll_mmi_read 0xF5100c

echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0xF32000
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0xF32004
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0xF32008
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0xF3200c
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0xF52000
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0xF52004
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0xF52008
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_FLOWID_LOWER_1 DP1 Word 3"
tn_ll_mmi_read 0xF5200c

echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_0 DP0 Word 0"
tn_ll_mmi_read 0xF33000
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_0 DP0 Word 1"
tn_ll_mmi_read 0xF33004
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_0 DP0 Word 2"
tn_ll_mmi_read 0xF33008
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_0 DP0 Word 3"
tn_ll_mmi_read 0xF3300c
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_1 DP1 Word 0"
tn_ll_mmi_read 0xF53000
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_1 DP1 Word 1"
tn_ll_mmi_read 0xF53004
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_1 DP1 Word 2"
tn_ll_mmi_read 0xF53008
echo "C_BASE_ADDR_STATISTICS_TX_GOOD_PRT_LOWER_1 DP1 Word 3"
tn_ll_mmi_read 0xF5300c
